// Bitcoin Lifeboat — owner runbook: singlesig-basic (US-032).
//
// Renders the sixteen §9.5 required sections for a single-signature wallet, in
// public-safe (default) or private export mode, with labeled blank fields. The
// sections, blocks, and the optional §14.3 privacy banner are built by
...
Recovery runbook for a single-signature wallet.
